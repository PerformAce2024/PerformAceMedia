...
const Third = () => {
  ...
  return (
    <div className="relative w-full max-w-7xl mx-auto py-8 px-4">
            <h2 className="text-5xl md:text-6xl font-bold text-center mb-12 mt-14">
        <span className="text-[#767475]">Why We Are </span><span className="text-black-600">Right Partner </span>       <span className="text-[#767475]">For </span><span className="text-black-600">Your Growth </span>
      </h2>
