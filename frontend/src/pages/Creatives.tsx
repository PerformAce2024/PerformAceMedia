...
// }) => {
//   const [selectedCreativeUrl, setSelectedCreativeUrl] = useState<string | null>(
//     defaultVideoUrl
//   );
...
//   return (
//     <div className="flex h-screen bg-[#EAE91]">
//       {/* Left Panel - Dropdowns */}
//       <div className="w-64 bg-primary text-white p-4 h-full overflow-auto">
//         <img className="w-xl h-xl mb-4" src="logo.png" alt="Logo"></img>
...
//       <div className="flex-1 flex flex-col items-center justify-start w-full h-screen">
//         {/* Top Bar */}
//         <div className="bg-primary text-white w-full rounded-l-md ml-2 p-5 flex justify-between items-center mb-4">
...
//         {/* TV Container */}
//         <div className="relative mt-20 w-[800px] h-[500px] rounded-md shadow-xs z-10">
//           {/* TV Image */}
//           <img src="tv.svg" alt="TV" className="w-full h-full object-contain" />

//           {/* Positioned Video Inside the TV Screen */}
//           {selectedCreativeUrl ? (
//             <video
//               ref={videoRef}
//               className="absolute top-[27px] left-[60px] w-[680px] h-[396px] object-fill bg-accent"
//               controls={false}
//             >
...
//             </video>
//           ) : (
//             <div className="absolute top-[180px] left-[330px] text-gray-400">
//               No creative selected
//             </div>
//           )}
//         </div>
//         <div className="absolute bottom-12 justify-center transform z-10 bg-black text-white rounded-md p-2 flex space-x-3">
...
//             </svg>
//           </button>
//           <div className="bg-black text-xs rounded px-2 py-1">Play Ad</div>
//         </div>
//         {/* Table (Simple Styling) */}
//         <div className="absolute top-[240px] left-[400px]">
//           <img className="w-fit" src="table.svg" alt="Table"></img>
//         </div>
//       </div>
